...
CREATE TABLE IF NOT EXISTS `csunvb_csu`.`guardcontents` (
  ...
  `day_check_user_id` INT NULL,
  `night_check_user_id` INT NULL,
  PRIMARY KEY (`id`),
  ...
  INDEX `fk_guardline_guardsheet` (`guard_line_id` ASC, `guardsheet_id` ASC),
...
-- -----------------------------------------------------
-- Table `csunvb_csu`.`comments`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `csunvb_csu`.`comments` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `users_id` INT NOT NULL,
  `guardcontents_id` INT NOT NULL,
  `comment` VARCHAR(45) NOT NULL,
  `carry_on` INT NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  INDEX `fk_comments_guardcontents1_idx` (`guardcontents_id` ASC),
  INDEX `fk_comments_users1_idx` (`users_id` ASC),
  CONSTRAINT `fk_comments_guardcontents1`
    FOREIGN KEY (`guardcontents_id`)
    REFERENCES `csunvb_csu`.`guardcontents` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
